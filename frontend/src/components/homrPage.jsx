      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between px-4 py-2">
          <div className="flex items-center space-x-2 md:space-x-4">
            <a href="https://www.instagram.com/cseapsgtech" target="_blank" rel="noopener noreferrer" className="hover:text-amber-300 transition">
              <FaInstagram size={24} />
            </a>
            <a href="https://www.linkedin.com/in/cseapsgtech" target="_blank" rel="noopener noreferrer" className="hover:text-amber-300 transition">
              <FaLinkedin size={24} />
            </a>
          </div>
